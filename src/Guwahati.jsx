...
export const  Guwahati = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Guwahati"); // Default selected city
 ...
 <Helmet>
    <title>Top Call Girls in Guwahati | Safe & Discreet Meetings at Locandu</title>
    <meta name="description" content="Discover the best call girls in Guwahati at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
    <meta name="keywords" content="Guwahati call girls,call girls Guwahati,Guwahati escorts,safe meetings Guwahati,call girl Guwahati,Guwahati redd liight area contact number,find girlfriend in Guwahati,Guwahati girl contact,Guwahati randi no,Guwahati girls mobile number,Guwahati girls no,Guwahati girl for friendship,Guwahati randi phone number,Guwahati girl number,Guwahati girls whatsapp number,call girl in Guwahati" />
    <meta property="og:title" content="Premium Call Girls in Guwahati | Locandu" />
    <meta property="og:description" content="Explore a wide selection of call girls in Guwahati with guaranteed safety and discretion. Find your perfect match today!" />
        ...
        <main className="bg-white rounded-lg shadow-lg p-8">
          <header className="bg-white rounded-lg shadow-md p-6 mb-16">
            <div className="relative">
              ...
              >
                <option value="agra">Guwahati</option>
