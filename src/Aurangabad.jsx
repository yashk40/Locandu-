...
export const Aurangabad = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Aurangabad"); // Change to Aurangabad
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Aurangabad | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Aurangabad at Locandu." />
        <meta name="keywords" content="Aurangabad call girls, call girls Aurangabad" />
        <meta property="og:title" content="Premium Call Girls in Aurangabad | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Aurangabad">{selectedCity}</Link></li>
          </ul>
