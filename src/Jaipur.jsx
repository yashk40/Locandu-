...
export const Jaipur = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Jaipur"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Jaipur | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Jaipur at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Jaipur call girls, call girls Jaipur, Jaipur escorts, safe meetings Jaipur" />
        <meta property="og:title" content="Premium Call Girls in Jaipur | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Jaipur">{selectedCity}</Link></li>
          </ul>
