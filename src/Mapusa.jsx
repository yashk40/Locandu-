...
export const Mapusa = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Mapusa"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Mapusa | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Mapusa at Locandu." />
        <meta name="keywords" content="Mapusa call girls, call girls Mapusa" />
        <meta property="og:title" content="Premium Call Girls in Mapusa | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Mapusa">{selectedCity}</Link></li>
          </ul>
