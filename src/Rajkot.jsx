...
export const Rajkot = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Rajkot"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        ...
        <meta name="keywords" content="Rajkot call girls, call girls Rajkot, Rajkot escorts, safe meetings Rajkot" />
