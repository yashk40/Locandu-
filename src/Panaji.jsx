...
export const Panaji = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Panaji"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Panaji | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Panaji at Locandu." />
        <meta name="keywords" content="Panaji call girls, call girls Panaji" />
        <meta property="og:title" content="Premium Call Girls in Panaji | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Panaji">{selectedCity}</Link></li>
          </ul>
