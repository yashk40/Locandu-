...
export const Junagadh = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Junagadh"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Junagadh | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Junagadh at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Junagadh call girls, call girls Junagadh, Junagadh escorts, safe meetings Junagadh" />
        <meta property="og:title" content="Premium Call Girls in Junagadh | Locandu" />
        <meta property="og:description" content="Explore a wide selection of call girls in Junagadh with guaranteed safety and discretion. Find your perfect match today!" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Junagadh">{selectedCity}</Link></li>
          </ul>
