...
export const Ranchi = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Ranchi"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
                 <Helmet>
    <title>Top Call Girls in Ranchi | Safe & Discreet Meetings at Locandu</title>
    <meta name="description" content="Discover the best call girls in Ranchi at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
    <meta name="keywords" content="Ranchi call girls,call girls Ranchi,Ranchi escorts,safe meetings Ranchi,call girl Ranchi,Ranchi redd liight area contact number,find girlfriend in Ranchi,Ranchi girl contact,Ranchi randi no,Ranchi girls mobile number,Ranchi girls no,Ranchi girl for friendship,Ranchi randi phone number,Ranchi girl number,Ranchi girls whatsapp number,call girl in Ranchi" />
    <meta property="og:title" content="Premium Call Girls in Ranchi | Locandu" />
    <meta property="og:description" content="Explore a wide selection of call girls in Ranchi with guaranteed safety and discretion. Find your perfect match today!" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Rajkot">{selectedCity}</Link></li>
          </ul>
