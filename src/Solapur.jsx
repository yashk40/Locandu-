...
export const Solapur = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Solapur"); // Change to Solapur
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Solapur | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Solapur at Locandu." />
        <meta name="keywords" content="Solapur call girls, call girls Solapur" />
        <meta property="og:title" content="Premium Call Girls in Solapur | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Solapur">{selectedCity}</Link></li>
          </ul>
