...
export const Kolhapur = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Kolhapur"); // Change to Kolhapur
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Kolhapur | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Kolhapur at Locandu." />
        <meta name="keywords" content="Kolhapur call girls, call girls Kolhapur" />
        <meta property="og:title" content="Premium Call Girls in Kolhapur | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Kolhapur">{selectedCity}</Link></li>
          </ul>
