...
export const NaviMumbai = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Navi Mumbai"); // Change to Navi Mumbai
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Navi Mumbai | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Navi Mumbai at Locandu." />
        <meta name="keywords" content="Navi Mumbai call girls, call girls Navi Mumbai" />
        <meta property="og:title" content="Premium Call Girls in Navi Mumbai | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-NaviMumbai">{selectedCity}</Link></li>
          </ul>
