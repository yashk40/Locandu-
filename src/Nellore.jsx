...
export const Nellore = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Nellore");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Nellore | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Nellore at Locandu." />
        <meta name="keywords" content="Nellore call girls, call girls Nellore" />
        <meta property="og:title" content="Premium Call Girls in Nellore | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Nellore">{selectedCity}</Link></li>
          </ul>
