...
export const Bicholim = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Bicholim"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Bicholim | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Bicholim at Locandu." />
        <meta name="keywords" content="Bicholim call girls, call girls Bicholim" />
        <meta property="og:title" content="Premium Call Girls in Bicholim | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Bicholim">{selectedCity}</Link></li>
          </ul>
