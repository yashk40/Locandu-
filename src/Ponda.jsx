...
export const Ponda = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Ponda"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Ponda | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Ponda at Locandu." />
        <meta name="keywords" content="Ponda call girls, call girls Ponda" />
        <meta property="og:title" content="Premium Call Girls in Ponda | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Ponda">{selectedCity}</Link></li>
          </ul>
