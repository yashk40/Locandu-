...
export const Kota = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Kota"); // Change to Kota
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Kota | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Kota at Locandu." />
        <meta name="keywords" content="Kota call girls, call girls Kota" />
        <meta property="og:title" content="Premium Call Girls in Kota | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Kota">{selectedCity}</Link></li>
          </ul>
