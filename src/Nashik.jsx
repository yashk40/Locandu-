...
export const Nashik = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Nashik"); // Change to Nashik
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        ...
        <meta name="description" content="Discover the best call girls in Nashik at Locandu." />
        <meta name="keywords" content="Nashik call girls, call girls Nashik" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Nashik">{selectedCity}</Link></li>
          </ul>
