...
export const Anantapur = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Anantapur | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Anantapur at Locandu." />
        <meta name="keywords" content="Anantapur call girls, call girls Anantapur" />
        <meta property="og:title" content="Premium Call Girls in Anantapur | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Anantapur">{selectedCity}</Link></li>
          </ul>
