...
export const Bengaluru = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Bengaluru"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Bengaluru | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Find the best call girls in Bengaluru for safe and discreet meetings." />
        <meta name="keywords" content="Bengaluru call girls, call girls Bengaluru, Bengaluru escorts" />
      </Helmet>
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Bengaluru">{selectedCity}</Link></li>
          </ul>
