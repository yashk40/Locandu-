...
export const Quepem = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Quepem"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Quepem | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Quepem at Locandu." />
        <meta name="keywords" content="Quepem call girls, call girls Quepem" />
        <meta property="og:title" content="Premium Call Girls in Quepem | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Quepem">{selectedCity}</Link></li>
          </ul>
