...
export const Jaisalmer = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Jaisalmer"); // Change to Jaisalmer
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Jaisalmer | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Jaisalmer at Locandu." />
        <meta name="keywords" content="Jaisalmer call girls, call girls Jaisalmer" />
        <meta property="og:title" content="Premium Call Girls in Jaisalmer | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Jaisalmer">{selectedCity}</Link></li>
          </ul>
