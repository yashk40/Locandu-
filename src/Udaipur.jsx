...
export const Udaipur = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Udaipur" && "Udaipur " ); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        ...
        <meta name="keywords" content="Udaipur call girls, call girls Udaipur, Udaipur escorts, safe meetings Udaipur" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Udaipur">{selectedCity}</Link></li>
          </ul>
