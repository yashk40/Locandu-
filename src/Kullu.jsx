...
export const Kullu = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Kullu"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Kullu | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Kullu at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Kullu call girls, call girls Kullu, Kullu escorts, safe meetings Kullu" />
        <meta property="og:title" content="Premium Call Girls in Kullu | Locandu" />
        <meta property="og:description" content="Explore a wide selection of call girls in Kullu with guaranteed safety and discretion. Find your perfect match today!" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Kullu">{selectedCity}</Link></li>
          </ul>
