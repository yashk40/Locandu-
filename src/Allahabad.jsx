...
export const Allahabad = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Allahabad"); // Default selected city
...
<Helmet>
    <title>Top Call Girls in Allahabad | Safe & Discreet Meetings at Locandu</title>
    <meta name="description" content="Discover the best call girls in Allahabad at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
    <meta name="keywords" content="Allahabad call girls,call girls Allahabad,Allahabad escorts,safe meetings Allahabad,call girl Allahabad,Allahabad redd liight area contact number,find girlfriend in Allahabad,Allahabad girl contact,Allahabad randi no,Allahabad girls mobile number,Allahabad girls no,Allahabad girl for friendship,Allahabad randi phone number,Allahabad girl number,Allahabad girls whatsapp number,call girl in Allahabad" />
    <meta property="og:title" content="Premium Call Girls in Allahabad | Locandu" />
    <meta property="og:description" content="Explore a wide selection of call girls in Allahabad with guaranteed safety and discretion. Find your perfect match today!" />
    ...
    <link rel="canonical" href="https://locandu.com/" />
      ...
      <div className="container">
        ...
        <ul class="breadcrumb-list flex text-white justify-center" id="text-callgirl">
                ...
                <li><Link to="/Call-girl-Allahabad">{selectedCity}</Link></li>
            </ul>
