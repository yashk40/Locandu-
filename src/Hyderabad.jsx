...
export const Hyderabad = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Hyderabad" && "Hyderabad " ); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Hyderabad | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Hyderabad at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Hyderabad call girls, call girls Hyderabad, Hyderabad escorts, safe meetings Hyderabad" />
      </Helmet>
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Hyderabad">{selectedCity}</Link></li>
          </ul>
