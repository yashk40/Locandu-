...
export const Vellore = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Vellore"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Vellore | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Vellore at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Vellore call girls, call girls Vellore, Vellore escorts, safe meetings Vellore" />
        <meta property="og:title" content="Premium Call Girls in Vellore | Locandu" />
        <meta property="og:description" content="Explore a wide selection of call girls in Vellore with guaranteed safety and discretion. Find your perfect match today!" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Vellore">{selectedCity}</Link></li>
          </ul>
