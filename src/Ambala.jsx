...
export const Ambala = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Ambala" && "Ambala " ); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        ...
        <meta name="keywords" content="Ambala call girls, call girls Ambala, Ambala escorts, safe meetings Ambala" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Ambala">{selectedCity}</Link></li>
          </ul>
