...
export const Sanguem = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Sanguem"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Sanguem | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Sanguem at Locandu." />
        <meta name="keywords" content="Sanguem call girls, call girls Sanguem" />
        <meta property="og:title" content="Premium Call Girls in Sanguem | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Sanguem">{selectedCity}</Link></li>
          </ul>
