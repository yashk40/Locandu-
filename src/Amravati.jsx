...
export const Amravati = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Amravati"); // Change to Amravati
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Amravati | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Amravati at Locandu." />
        <meta name="keywords" content="Amravati call girls, call girls Amravati" />
        <meta property="og:title" content="Premium Call Girls in Amravati | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Amravati">{selectedCity}</Link></li>
          </ul>
