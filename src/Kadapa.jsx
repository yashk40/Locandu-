...
export const Kadapa = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Kadapa");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Kadapa | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Kadapa at Locandu." />
        <meta name="keywords" content="Kadapa call girls, call girls Kadapa" />
        <meta property="og:title" content="Premium Call Girls in Kadapa | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Kadapa">{selectedCity}</Link></li>
          </ul>
