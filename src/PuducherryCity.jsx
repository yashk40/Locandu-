...
export const PuducherryCity = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Puducherry City"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Puducherry City | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Puducherry City at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Puducherry City call girls, call girls Puducherry City, Puducherry City escorts, safe meetings Puducherry City" />
        <meta property="og:title" content="Premium Call Girls in Puducherry City | Locandu" />
        <meta property="og:description" content="Explore a wide selection of call girls in Puducherry City with guaranteed safety and discretion. Find your perfect match today!" />
      </Helmet>
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-PuducherryCity">{selectedCity}</Link></li>
          </ul>
