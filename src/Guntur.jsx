...
export const Guntur = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Guntur | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Guntur at Locandu." />
        <meta name="keywords" content="Guntur call girls, call girls Guntur" />
        <meta property="og:title" content="Premium Call Girls in Guntur | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Guntur">{selectedCity}</Link></li>
          </ul>
