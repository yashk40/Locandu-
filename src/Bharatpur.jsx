...
export const Bharatpur = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Bharatpur"); // Default selected city
...
<Helmet>
    <title>Top Call Girls in Barmer | Safe & Discreet Meetings at Locandu</title>
    <meta name="description" content="Discover the best call girls in Barmer at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
    <meta name="keywords" content="Barmer call girls,call girls Barmer,Barmer escorts,safe meetings Barmer,call girl Barmer,Barmer redd liight area contact number,find girlfriend in Barmer,Barmer girl contact,Barmer randi no,Barmer girls mobile number,Barmer girls no,Barmer girl for friendship,Barmer randi phone number,Barmer girl number,Barmer girls whatsapp number,call girl in Barmer" />
    <meta property="og:title" content="Premium Call Girls in Barmer | Locandu" />
    <meta property="og:description" content="Explore a wide selection of call girls in Barmer with guaranteed safety and discretion. Find your perfect match today!" />
    ...
    <link rel="canonical" href="https://locandu.com/" />
      ...
      <div className="container">
        ...
        <ul class="breadcrumb-list flex text-white justify-center" id="text-callgirl">
                ...
                <li><Link to="/Call-girl-Barmer">{selectedCity}</Link></li>
            </ul>
