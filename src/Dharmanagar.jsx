...
export const Dharmanagar = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Dharmanagar"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Dharmanagar | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Find the best call girls in Dharmanagar for safe and discreet meetings." />
        <meta name="keywords" content="Dharmanagar call girls, call girls Dharmanagar, Dharmanagar escorts" />
      </Helmet>
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Dharmanagar">{selectedCity}</Link></li>
          </ul>
