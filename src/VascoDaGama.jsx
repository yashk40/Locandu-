...
export const VascoDaGama = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Vasco da Gama"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Vasco da Gama | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Vasco da Gama at Locandu." />
        <meta name="keywords" content="Vasco da Gama call girls, call girls Vasco da Gama" />
        <meta property="og:title" content="Premium Call Girls in Vasco da Gama | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Vasco-da-Gama">{selectedCity}</Link></li>
          </ul>
