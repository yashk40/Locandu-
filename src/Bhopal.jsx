...
export const Bhopal = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Bhopal"); // Change to Bhopal
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Bhopal | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Bhopal at Locandu." />
        <meta name="keywords" content="Bhopal call girls, call girls Bhopal" />
        <meta property="og:title" content="Premium Call Girls in Bhopal | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Bhopal">{selectedCity}</Link></li>
          </ul>
