...
export const Chittoor = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Chittoor");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Chittoor | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Chittoor at Locandu." />
        <meta name="keywords" content="Chittoor call girls, call girls Chittoor" />
        <meta property="og:title" content="Premium Call Girls in Chittoor | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Chittoor">{selectedCity}</Link></li>
          </ul>
