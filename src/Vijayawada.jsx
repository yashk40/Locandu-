...
export const Vijayawada = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Vijayawada | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Vijayawada at Locandu." />
        <meta name="keywords" content="Vijayawada call girls, call girls Vijayawada" />
        <meta property="og:title" content="Premium Call Girls in Vijayawada | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Vijayawada">{selectedCity}</Link></li>
          </ul>
