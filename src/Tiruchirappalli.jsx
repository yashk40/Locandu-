...
export const Tiruchirappalli = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Tiruchirappalli"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Tiruchirappalli | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Tiruchirappalli at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Tiruchirappalli call girls, call girls Tiruchirappalli, Tiruchirappalli escorts, safe meetings Tiruchirappalli" />
        <meta property="og:title" content="Premium Call Girls in Tiruchirappalli | Locandu" />
        <meta property="og:description" content="Explore a wide selection of call girls in Tiruchirappalli with guaranteed safety and discretion. Find your perfect match today!" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Tiruchirappalli">{selectedCity}</Link></li>
          </ul>
