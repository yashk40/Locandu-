...
export const Thane = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Thane"); // Change to Thane
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Thane | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Thane at Locandu." />
        <meta name="keywords" content="Thane call girls, call girls Thane" />
        <meta property="og:title" content="Premium Call Girls in Thane | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Thane">{selectedCity}</Link></li>
          </ul>
