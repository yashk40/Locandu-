...
export const Rangareddy = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Rangareddy"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Rangareddy | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Rangareddy at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Rangareddy call girls, call girls Rangareddy, Rangareddy escorts, safe meetings Rangareddy" />
        <meta property="og:title" content="Premium Call Girls in Rangareddy | Locandu" />
        <meta property="og:description" content="Explore a wide selection of call girls in Rangareddy with guaranteed safety and discretion. Find your perfect match today!" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Rangareddy">{selectedCity}</Link></li>
          </ul>
