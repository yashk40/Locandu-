...
export const Rajahmundry = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Rajahmundry");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Rajahmundry | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Rajahmundry at Locandu." />
        <meta name="keywords" content="Rajahmundry call girls, call girls Rajahmundry" />
        <meta property="og:title" content="Premium Call Girls in Rajahmundry | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Rajahmundry">{selectedCity}</Link></li>
          </ul>
