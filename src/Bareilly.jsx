...
export const Bareilly = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Bareilly"); // Default selected city
...
<Helmet>
    <title>Top Call Girls in Bareilly | Safe & Discreet Meetings at Locandu</title>
    <meta name="description" content="Discover the best call girls in Bareilly at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
    <meta name="keywords" content="Bareilly call girls,call girls Bareilly,Bareilly escorts,safe meetings Bareilly,call girl Bareilly,Bareilly redd liight area contact number,find girlfriend in Bareilly,Bareilly girl contact,Bareilly randi no,Bareilly girls mobile number,Bareilly girls no,Bareilly girl for friendship,Bareilly randi phone number,Bareilly girl number,Bareilly girls whatsapp number,call girl in Bareilly" />
    <meta property="og:title" content="Premium Call Girls in Bareilly | Locandu" />
    <meta property="og:description" content="Explore a wide selection of call girls in Bareilly with guaranteed safety and discretion. Find your perfect match today!" />
    ...
    <link rel="canonical" href="https://locandu.com/" />
      ...
      <div className="container">
        ...
        <ul class="breadcrumb-list flex text-white justify-center" id="text-callgirl">
                ...
                <li><Link to="/Call-girl-Bareilly">{selectedCity}</Link></li>
            </ul>
