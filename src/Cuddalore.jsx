...
export const Cuddalore = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Cuddalore"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Cuddalore | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Cuddalore at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Cuddalore call girls, call girls Cuddalore, Cuddalore escorts, safe meetings Cuddalore" />
        <meta property="og:title" content="Premium Call Girls in Cuddalore | Locandu" />
        <meta property="og:description" content="Explore a wide selection of call girls in Cuddalore with guaranteed safety and discretion. Find your perfect match today!" />
      </Helmet>
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Cuddalore">{selectedCity}</Link></li>
          </ul>
