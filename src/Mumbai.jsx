...
export const Mumbai = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Mumbai"); // Change to Mumbai
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        ...
        <meta name="description" content="Discover the best call girls in Mumbai at Locandu." />
        <meta name="keywords" content="Mumbai call girls, call girls Mumbai" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Mumbai">{selectedCity}</Link></li>
          </ul>
