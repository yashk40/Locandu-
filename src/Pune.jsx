...
export const Pune = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Pune"); // Change to Pune
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        ...
        <meta name="description" content="Discover the best call girls in Pune at Locandu." />
        <meta name="keywords" content="Pune call girls, call girls Pune" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Pune">{selectedCity}</Link></li>
          </ul>
