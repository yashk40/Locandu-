...
export const Margao = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Margao"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Margao | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Margao at Locandu." />
        <meta name="keywords" content="Margao call girls, call girls Margao" />
        <meta property="og:title" content="Premium Call Girls in Margao | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Margao">{selectedCity}</Link></li>
          </ul>
