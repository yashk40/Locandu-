...
export const Ludhiana = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Ludhiana"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
                 <Helmet>
    <title>Top Call Girls in Ludhiana | Safe & Discreet Meetings at Locandu</title>
    <meta name="description" content="Discover the best call girls in Ludhiana at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
    <meta name="keywords" content="Ludhiana call girls,call girls Ludhiana,Ludhiana escorts,safe meetings Ludhiana,call girl Ludhiana,Ludhiana redd liight area contact number,find girlfriend in Ludhiana,Ludhiana girl contact,Ludhiana randi no,Ludhiana girls mobile number,Ludhiana girls no,Ludhiana girl for friendship,Ludhiana randi phone number,Ludhiana girl number,Ludhiana girls whatsapp number,call girl in Ludhiana" />
    <meta property="og:title" content="Premium Call Girls in Ludhiana | Locandu" />
    <meta property="og:description" content="Explore a wide selection of call girls in Ludhiana with guaranteed safety and discretion. Find your perfect match today!" />
        ...
        <main className="bg-white rounded-lg shadow-lg p-8">
          <header className="bg-white rounded-lg shadow-md p-6 mb-16">
            <div className="relative">
              ...
              >
                <option value="agra">Vadodara</option>
