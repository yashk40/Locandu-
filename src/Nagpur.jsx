...
export const Nagpur = () => {
  ...
  const [selectedCity, setSelectedCity] = useState("Nagpur"); // Change to Nagpur
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        ...
        <meta name="description" content="Discover the best call girls in Nagpur at Locandu." />
        <meta name="keywords" content="Nagpur call girls, call girls Nagpur" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Nagpur">{selectedCity}</Link></li>
          </ul>
