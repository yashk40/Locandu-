...
export const Gwalior = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Gwalior"); // Change to Gwalior
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        ...
        <meta name="description" content="Discover the best call girls in Gwalior at Locandu." />
        <meta name="keywords" content="Gwalior call girls, call girls Gwalior" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Gwalior">{selectedCity}</Link></li>
          </ul>
