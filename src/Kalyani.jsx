...
export const Kalyani = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Kalyani"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Kalyani | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Kalyani at Locandu. With thousands of options, we ensure safe and discreet meetings tailored to your preferences." />
        <meta name="keywords" content="Kalyani call girls, call girls Kalyani, Kalyani escorts, safe meetings Kalyani" />
      </Helmet>
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Kalyani">{selectedCity}</Link></li>
          </ul>
