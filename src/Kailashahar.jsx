...
export const Kailashahar = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Kailashahar"); // Default selected city
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Kailashahar | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Find the best call girls in Kailashahar for safe and discreet meetings." />
        <meta name="keywords" content="Kailashahar call girls, call girls Kailashahar, Kailashahar escorts" />
      </Helmet>
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Kailashahar">{selectedCity}</Link></li>
          </ul>
