...
export const Kakinada = () => {
  const [users, setUsers] = useState([]);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [selectedCity, setSelectedCity] = useState("Kakinada");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Kakinada | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Kakinada at Locandu." />
        <meta name="keywords" content="Kakinada call girls, call girls Kakinada" />
        <meta property="og:title" content="Premium Call Girls in Kakinada | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Kakinada">{selectedCity}</Link></li>
          </ul>
