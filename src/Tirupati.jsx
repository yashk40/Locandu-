...
export const Tirupati = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        <title>Top Call Girls in Tirupati | Safe & Discreet Meetings at Locandu</title>
        <meta name="description" content="Discover the best call girls in Tirupati at Locandu." />
        <meta name="keywords" content="Tirupati call girls, call girls Tirupati" />
        <meta property="og:title" content="Premium Call Girls in Tirupati | Locandu" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li><Link to="/Call-girl-Tirupati">{selectedCity}</Link></li>
          </ul>
