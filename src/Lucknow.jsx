  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Helmet>
        ...
        <meta name="keywords" content="Lucknow call girls, call girls Lucknow, Lucknow escorts, safe meetings Lucknow" />
      ...
      <div className="container">
        <main className="bg-[#421493] p-8 w-screen">
          <ul className="breadcrumb-list flex text-white justify-center" id="text-callgirl">
            ...
            <li className="px-2">&gt;</li>
            <li><Link to="/Call-girl-Lucknow">{selectedCity}</Link></li>
          </ul>
